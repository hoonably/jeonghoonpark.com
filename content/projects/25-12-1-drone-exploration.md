...
description: "Developed a Unity–Arduino drone control system with autonomous multi-agent path planning and automated deployment for collaborative exploration."
